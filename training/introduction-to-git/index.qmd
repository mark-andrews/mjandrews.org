---
title: Using Git and GitHub for R based data analysis projects
...
Further resources for this training course can be found on Github at [mark-andrews/introduction-to-git](https://github.com/mark-andrews/introduction-to-git).
