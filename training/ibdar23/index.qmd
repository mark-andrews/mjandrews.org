...
using R. The course covers fundamental concepts of Bayesian inference and
modelling, and demonstrates how to perform Bayesian data analysis in practice
using R and the `brms` package. Topics include Bayesian approaches to linear
regression, generalized linear models, and multilevel and mixed effects models.
The course also includes practical applications of Stan based Markov Chain
