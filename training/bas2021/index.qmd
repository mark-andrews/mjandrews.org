...
description: This four-day online course provides an introduction to advanced topics in statistics and data science using R. The course covers data wrangling, data visualization, processing and visualizing NetCDF satellite data, programming in R, reproducible data analysis with RMarkdown, and various linear models. The course is practical, hands-on, and workshop-based with minimal lecture-style presentations.
subtitle: 14-23 September, 2021
...
Instructions on how to install the required software is provided [here](https://github.com/mark-andrews/bas2021datascience).
...
Further resources for this training course can be found on Github at [mark-andrews/bas2021datascience](https://github.com/mark-andrews/bas2021datascience).
