...
On the other hand, for those wishing to install on their own devices (Windows or Macs), instructions are available [here](https://github.com/mark-andrews/intropy4ds/blob/master/software.md).

# GitHub resources

Further resources for this training course can be found on Github at [mark-andrews/intropy4ds](https://github.com/mark-andrews/intropy4ds).
