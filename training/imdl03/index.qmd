...
author: "Mark Andrews"
subtitle: '29-30 June, 2022'
date: '29 June, 2022'
location: Online
description: "This two-day course offers an introduction to machine learning and deep learning using R. The course covers major machine learning applications, including binary and multiclass classification problems, decision trees, random forests, and unsupervised learning methods. It also delves into artificial neural networks and deep learning, using TensorFlow and Keras deep learning toolboxes. The course is designed to be hands-on and workshop-based, with examples and exercises to reinforce learning."
categories: ["Machine Learning", "Deep Learning", "R", "TensorFlow", "Keras"]
---
