---
title: Introduction to Machine Learning and Deep Learning using Python
...
and are available on Windows, MacOs, and Linux. We will also provide time during the workshops to ensure that all software is
...
Further resources for this training course can be found on Github at [mark-andrews/pyml01](https://github.com/mark-andrews/pyml01).
