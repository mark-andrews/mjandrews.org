...
author: "Mark Andrews"
subtitle: '15-16 June, 2022'
date: '15 June, 2022'
location: Online
description: |
  This two-day course provides a comprehensive understanding of statistical
  model building, evaluation, selection, comparison, simplification, and
  averaging. It delves into measuring model fit, predictive performance, nested
  model comparison, out-of-sample predictive performance, over-fitting, and
  various methods of variable selection. The course concludes with a focus on
  model averaging and Bayesian methods of model comparison.
categories:
- Model Evaluation
