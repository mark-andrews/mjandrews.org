---
title: Introduction to Multilevel (hierarchical, or mixed effects) Models
date: November 10, 2021
description: This two-day course provides a comprehensive introduction to multilevel models, focusing on multilevel linear models and Bayesian approaches. The course covers random effects models, linear mixed effects models, and multilevel models for nested and crossed data. It also includes practical sessions using R.
subtitle: 10-11 November, 2021
...
Further resources for this training course can be found on Github at [mark-andrews/immr05](https://github.com/mark-andrews/immr05).
